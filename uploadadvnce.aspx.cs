...
{
    public partial class uploadadvnce : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                //cls.FillCmb("select FT_Name,FT_ID  from Filetypelst ", cmbfiletype, "Select Type", cmbfiletype);
            }
        }
        ...
        public void insert()
        {
            try
            {
                ...
                obj.UP_FileTypeId = 1;// Convert.ToInt32(cmbfiletype.SelectedValue);
        ...
        {
            if (cls.IsExists("select * from advncuploadfileslist where UP_FileName='" + txtfilename.Text + "' ") == true)
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "popup",
            ...
            else
            {
                try
                {
                    ...
                    FileUpload1.SaveAs(Server.MapPath("~/all/advance/") + filename);
                    Passphrase = filename;
